    ...
    <div>
      <Modal show={props.showModal} onHide={props.closeModal} size="lg" centered>
        ...
        <div id="invoiceCapture">
          ...
          <img src="washing-machine.png" alt=" Logo" height = {70} width = {70}/>
            <div className="w-100 ml-6" style = {{marginLeft:'20px'}}>
              <h4 className="fw-bold my-2 ">{props.info.billFrom || 'GANESH DRY CLEANING SERVICES'}</h4>
          ...
          <div className="p-4">
            <Row className="mb-4">
              ...
              <Col md={4}>
                ...
                <div>heelkartikrajak123@gmail.com</div>
                <div>In Front of Kal-Bhairav Mandir, Shastri Nagar, Jabalpur., Madhya Pradesh 482003</div>
              </Col>
              <Col md={4}>
